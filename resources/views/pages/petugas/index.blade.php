                                        ...
                                        <form id="Form-Create" class="form-horizontal form-label-left">
                                            <div class="form-group">
                                                <label class="control-label col-sm-3">
                                                    Kode Petugas </label>
                                                <div class="col-sm-6">
                                                    <input type="text" name="kode_petugas" id="kode_petugas"
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#Form-Create").submit(function (event) {
                ...
                var $form = $(this),
                        kode_petugas = $form.find("input[name='kode_petugas']").val(),
                        nama_petugas = $form.find("input[name='nama_petugas']").val();
//                $("#Form-Create").reset();
                var posting = $.post('/petugas', {
...
//                    getAjax();
        ...
        function getAjax() {
            ...
            setTimeout(function () {
                $.getJSON("/data-petugas", function (data) {
...
//                    var $form = $(this),
                        ...
                        $("input[name='kode_petugas']").val(data.kode_petugas);
...
//                    $('#loader').hide();
                    $("#loader-wrapper").hide();
                    $("#modal-body").append(
                            "<tr><td> Kode Petugas </td><td> : </td><td>" + data.kode_petugas + "</td></tr>" +
                            "<tr><td> Nama Petugas </td><td> : </td><td>" + data.nama_petugas + "</td></tr>"
                    );
                }
            });
        }
